C IRISUB.FOR, Version 2001.04, September 19, 2001
C 
C includes subroutines IRI_SUB to compute IRI parameters for specified
...
c month, day of month, day of year, or hour (UT or LT). IRI_WEB requires
...
C-Ver.----MM/DD/YY-----------------------------------------------------------
C2000.01- 05/09/00 B0_98 replaces B0_TAB and B1 varies from 1.9/day to 2.6/night
C2000.02- 06/11/00 including new F1 and indermediate region
C2000.03- 10/15/00 include Scherliess-Fejer drift model
C2000.04- 10/29/00 include special option for D region models
C2000.05- 12/07/00 change name IRIS13 to IRISUB
C2000.06- 12/14/00 jf(30),outf(20,100),oarr(50)
C2001.01- 03/17/01 include Truhlik-Triskova Te model and IGRF
C2001.02- 05/07/01 include Fuller-Rowell-Condrescu storm model 
C2001.03- 07/09/01 LATI instead of LAT1 in F00 call (M. Torkar)
C2001.03- 07/09/01 sdte instead of dte in ELTEIK call (P. Wilkinson)
...
5592    continue
	...
	sam_ut=(ut.eq.ut0)
        if(sam_date.and..not.rzino.and..not.rzin) goto 2910
...
c104   	FORMAT('/home/ingemar/gup/dun/iri2001/ccir',I2,'.asc')
...
c1144  	  FORMAT('/home/ingemar/gup/dun/iri2001/ursi',I2,'.asc')
c-web- special for web-version:
...
c			endif
	...
	if(height.lt.550.) then
     ...
     &          	xl,icode,dipl,babs)
		if(xl.gt.30.) xl=30.
		call elteik(icd,isa,0,invdip,xl,dimo,babs,
     &			dipl,hour,550.,daynr,f107d,teh2,sdte)
		teh=teh1+(teh2-teh1)/(550.-ahh(4))*(height-ahh(4))
		goto 2918
		endif
        call igrf_sub(lati,longi,ryear,height,
     &          xl,icode,dipl,babs)
	if(xl.gt.30.) xl=30.
	call elteik(icd,isa,0,invdip,xl,dimo,babs,dipl,hour,
     &		height,daynr,f107d,teh,sdteh)
