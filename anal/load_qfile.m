...
d_parbl(43:55)=[a(1) mode wavegate range0 range1 numofrange length(ACF)/numofrange size(PSD,1) deltalag double([bjt_h bjt_m bjt_s]) bjt_ms];
d_parbl(41)=9;
d_parbl(1:6)=a(2:7);
