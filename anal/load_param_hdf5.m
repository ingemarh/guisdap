...
%err2d_id  = [28 30 29 32 31];             % [dne dtr dti dvi dco], [var_Ne, var_Tr, var_Ti, var_Vi, var_Collf]
err2d_id  = [142 144 143 146 145];         % [var_Ne var_Tr var_Ti var_Vi var_Collf]
...
for ii = 1:n_tot
    ...
    err2D(1:nh(ii),ii,:) = sqrt(err2d(altrange,:));    % variance --> error
