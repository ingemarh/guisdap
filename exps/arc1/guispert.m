...
ch_Pt=ch_Pt(1);
if name_site=='T'
 npp=426; npr=5808; nslic=9; prep=443904;
 lpg_bcs(1:nslic)='x';
elseif name_site=='L'
 npp=505; npr=7072; nslic=10; prep=1009920/2;
 lpg_bcs(1:nslic)='x';
else
 npp=94; npr=0; nslic=1; prep=0;
 ch_height=292.9;
end
...
for slic=0:nslic-1
 ...
 d_data(nsig)=zerolagfix(d_data(nsig),d_data(slic*npp+(1:npp)),128);
end
