...
%   COR_pp(50712,1,vc,'c',1,21,0,1)
    ...
    COR_uprog(Asplit+0,1,vc,'s',1,600,(0:5)*14,0,2)
    COR_fraclp(Asplit+3585,vc,'s',510,16,84,(1:47)*14,2)
    COR_uprog(Asplit+50733,1,vc,'b',1,600,(0:5)*14,0,2)
    COR_pp(Asplit+54318,1,vc,'c',1,21,0,2)
end
