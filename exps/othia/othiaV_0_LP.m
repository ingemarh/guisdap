...
for vc=1:3:N_SCAN*3
    ...
    %COR_fdalt(142652,vc+rem(i+1,3),'s',0,0,2,3,360,836-60,(0:45)*12,1)
    COR_uprog(142844,1,vc+rem(i+2,3),'b',1,836,(0:29)*12,0,1)
    COR_pp(0,1,vc+rem(i,3),'c',1,12,0,1)
    COR_pp(24657,1,vc+rem(i+1,3),'c',1,12,0,1)
    COR_pp(142832,1,vc+rem(i+2,3),'c',1,12,0,1)
end
