...
if name_site=='V'
  ...
  if fix(expver)==4
    ...
    analysis_lpf(5).lib='restore';
    analysis_lpf(5).data=20+65482*2;
    analysis_lpf(5).nrep=1;
    analysis_lpf(6)=analysis_lpf(2);
    analysis_lpf(6).raw=32768*2+3014400;
    analysis_lpf(7)=analysis_lpf(3);
    analysis_lpf(7).raw=32768*2+3014400;
    analysis_lpf(7).data=20*2+65482*2;
    analysis_lpf(8)=analysis_lpf(4);
    analysis_lpf(8).raw=32768*2+3014400;
    analysis_lpf(8).data=20*2+65482*3;
  end
end
...
if (name_site=='T' | name_site=='L' | name_site=='V')
 a_satch.repair=63; 
 a_satch.skip=1;
 analysis_range=[20:69,logspace(log10(70),log10(500),100)];
