...
if nargin==0, size=5000; nfir=1; end
if nargin==1, nfir=1; end
lp_t1=zeros(1,size);
lp_t2=zeros(1,size);
lp_h=zeros(1,size);
lp_ra=zeros(1,size);
lp_nfir=zeros(1,size);
lp_fir=zeros(nfir,size);
lp_dec=zeros(1,size);
lp_T=zeros(1,size);
lp_dt=zeros(1,size);
lp_nt=zeros(1,size);
